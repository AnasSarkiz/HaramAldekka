            ...
            <div className="bg-white rounded-2xl shadow-xl p-8 md:p-12 mb-12">
              ...
              <div className="prose prose-lg text-gray-600 text-left max-w-3xl mx-auto">
                ...
                <div className="flex justify-center">
                  <img src="https://media.istockphoto.com/id/1037473802/photo/3d-rendering-circuit-board-and-gold-glow-chip.jpg?s=2048x2048&w=is&k=20&c=u-oHdIgbWa9lfAaKd8NUr_s0vbDdL5v3CULy4DEwU9g=" alt="Company Overview" className="w-full m-8 align-center justify-center h-full object-cover" />
                </div>
                
                <div className="mt-12 pt-8 border-t border-gray-200">
                  <h3 className="text-2xl font-semibold text-gray-900 mb-6">{t('contact')}</h3>
                  <div className="flex flex-col sm:flex-row justify-center gap-4">
                    <a href="tel:+218929807050" className="inline-flex items-center justify-center px-6 py-3 border border-transparent text-base font-medium rounded-md text-white bg-gray-600 hover:bg-gray-800">
                      <svg className="h-5 w-5 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
                      </svg>
                      {t('call.us')}
                    </a>
                    <a href="mailto:Mohamedalnaile0@gmail.com" className="inline-flex items-center justify-center px-6 py-3 border border-gray-300 text-base font-medium rounded-md text-gray-700 bg-white hover:bg-gray-50">
                      <svg className="h-5 w-5 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
