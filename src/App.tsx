              ...
              <div className="prose prose-lg text-gray-600 text-left max-w-3xl mx-auto">
                ...
                <div className="mt-12 pt-8 border-t border-gray-200">
                  ...
                  <div className="flex flex-col sm:flex-row justify-center gap-4">
                    ...
                    <a href="mailto:Haramaldekka@gmail.com" className="inline-flex items-center justify-center px-6 py-3 border border-gray-300 text-base font-medium rounded-md text-gray-700 bg-white hover:bg-gray-50">
                      <svg className="h-5 w-5 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
